    ...
    endpoints: [
      {
        ...
        extendedQueryParams: [
            { name: 'where[closed_after]', type: 'timestamp' },
            { name: 'where[closed_before]', type: 'timestamp' },
    ...
    endpoints: [
      ...
      // Project Cards
      {
        ...
        extendedQueryParams: [
            ...
            { name: 'where[types][]', type: 'Array', isRequired: false, note: 'Array of <code class="inline">issue</code>, <code class="inline">pull_request</code> or <code class="inline">null</code>' },
            { name: 'where[updated_after]', type: 'timestamp' },
            { name: 'where[updated_before]', type: 'timestamp' },
